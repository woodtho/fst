...
export default function LexiconTool() {
  ...
  return (
    <>
      ...
      <h1>Lexicon tool</h1>
      <p className="lead">{entries.length.toLocaleString()} vocabulary entries from the PFL2 source Lexique (SC102-2/1-2-2005F), French ↔ English, organized by objective.</p>
